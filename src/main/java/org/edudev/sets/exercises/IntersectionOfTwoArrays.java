...
final class IntersectionOfTwoArrays {
    ...
    void main() {
        ...
        System.out.println("-----------------");
        System.out.println();
        Arrays.stream(intersectionTwo(new int[]{1, 2, 2, 1}, new int[]{2, 2})).forEach(System.out::println);
        System.out.println("-----------------");
        Arrays.stream(intersectionTwo(new int[]{4, 9, 5}, new int[]{9, 4, 9, 8, 4})).forEach(System.out::println);
        System.out.println("-----------------");
    ...
    public static int[] intersectionTwo(final int[] nums1, final int[] nums2) {
        final Set<Integer> setNums1 = new HashSet<>();
        ...
        for (final var num : intersection)
            result[i++] = num;
